...
class AdminTest extends \WP_Mock\Tools\TestCase {
	...
	public function setUp(): void {
		...
		require_once( $basedir . '/trunk/admin/class-ea-wp-aws-sns-client-rest-endpoint-admin.php' );
	...
	public function test_display_pending_subscriptions() {
		...
		\WP_Mock::userFunction( 'add_query_arg', array(
			'args' => array( array( 'action' => 'ea_sns_confirm', 'subscription' => '88685c78-1e4b-4aab-be1c-5aa353b575dd' ), 'https://wordpress.site/wp-admin/plugins.php?plugin_status=all&paged=1&s' ),
			'times' => 1,
		...
		\WP_Mock::userFunction( 'add_query_arg', array(
			'args' => array( array( 'action' => 'ea_sns_dismiss', 'subscription' => '88685c78-1e4b-4aab-be1c-5aa353b575dd' ), 'https://wordpress.site/wp-admin/plugins.php?plugin_status=all&paged=1&s' ),
			'times' => 1,
